...
// ══════════════════════════════════════════════════════════
// ── Page config ───────────────────────────────────────────
const stickyNavbar = false; // true = navbar always visible, false = navbar hidden until scroll

const POLL_INTERVAL = 10_000; // 10s
const NAV_THRESHOLD = 100; // scroll threshold for navbar reveal (if stickyNavbar = false)
const HERO_CONTENT_THRESHOLD = 120; // scroll threshold for hero overlay content (logo, title, buttons)
...
const TexturePackPage = () => {
  ...
  // Hero overlay content (logo, title, buttons) appears after HERO_CONTENT_THRESHOLD
  const showHeroContent = scrollY > HERO_CONTENT_THRESHOLD;
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* ── Hero Section ─────────────────────────────────── */}
      {/* Hero background image - fades out on scroll */}
      <div style={{ opacity: heroOpacity }} className="will-change-[opacity]">
        <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
          ...
          {/* Hero overlay content - hidden at scrollY=0, reveals after threshold */}
          <div
          ...
          >
            ...
            <p className="text-lg sm:text-xl max-w-2xl mx-auto mb-8 font-body">
